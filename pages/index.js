    ...
    fetchNFTs()
      .then((items) => {
        if (isMounted) {
          ...
          // Filter out non- NFTs (assuming  NFTs are identified by having an audio file URL)
          const musicNFTs = items.filter((item) => item.image);
          // console.log(" NFTs: ", musicNFTs);
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        <Banner
          name={(<>Discover, collect, and sell <br /> on Artsphere marketplace</>)}
        ...
        {!isLoading && !nfts.length ? (
          ...
          <>
            <div>
              <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">Top NFT Creators</h1>
